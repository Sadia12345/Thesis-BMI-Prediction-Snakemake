...
\end{equation}
This step reduced the feature space from ~6,300 to ~1,500, significantly lowering the RAM footprint (see Figure \ref{fig:feature_reduction}). Additionally, demographic covariates such as Age and Sex were excluded from the feature set to ensure the model relies solely on microbial abundance data for prediction.
